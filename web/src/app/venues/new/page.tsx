                ...
                <div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <textarea name="curationNote" rows={3} className="w-full border border-[#dfe3ea] focus:border-[#c2a15a] rounded-xl px-4 py-2.5 text-[14px] outline-none resize-y" placeholder="例：個室は防音に優れ、周囲を気にせず商談可能。女将の気配りが素晴らしく会食向き。" />
                        </div>
